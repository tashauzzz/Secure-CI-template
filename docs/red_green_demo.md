...
This demonstrates that the reviewed repository state passes the full security pipeline and produces the expected report set.
...
The red scenarios below show representative blocking behavior when a pipeline stage detects a policy-violating condition.
